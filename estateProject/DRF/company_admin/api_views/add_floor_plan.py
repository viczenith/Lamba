...
from DRF.company_admin.serializers.estate_assets_serializers import EstateFloorPlanSerializer
from DRF.company_admin.serializers.simple_serializers import PlotSizeSerializer
