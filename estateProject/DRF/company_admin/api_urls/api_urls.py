...
from DRF.company_admin.api_views.dashboard_views import admin_dashboard_data
# from DRF.company_admin.api_views.admin_estate_views import admin_estate_list
from DRF.company_admin.api_views.admin_estate_allocated_view import get_estate_full_allocation_details, update_allocated_plot_for_estate
from DRF.company_admin.api_views.edit_estate_plot_views import edit_estate_plot
from DRF.company_admin.api_views.update_allocated_plot import (
    update_allocated_plot, 
    load_plots)


from DRF.company_admin.api_views.estate_layout_upload import upload_estate_layout
from DRF.company_admin.api_views.estate_plot_prototype_upload import upload_estate_prototype
from DRF.company_admin.api_views.add_floor_plan import upload_floor_plan, get_plot_sizes
from DRF.company_admin.api_views.add_amenity_views import update_estate_amenities, get_available_amenities
from DRF.company_admin.api_views.add_progress_status_views import update_work_progress
from DRF.company_admin.api_views.add_estate_map_views import update_estate_map
from DRF.company_admin.api_views.estate_detail_views import (
    # estate_detail,
    get_estate_details,
    estate_list,
    estate_floor_plans,
...
from DRF.company_admin.api_views.add_estate_views import AddEstateView
# from DRF.company_admin.api_views.plot_size_number_views import PlotSizeView, PlotNumberView

from DRF.company_admin.api_views.chat_list_views import ClientChatListView
from DRF.company_admin.api_views.load_plots import load_plots
from DRF.company_admin.api_views.plot_allocation_delete import delete_allocation
from DRF.company_admin.api_views.download_allocations import download_allocations
from DRF.company_admin.api_views.download_estate_pdf import download_estate_pdf
from DRF.company_admin.api_views.user_registration_views import admin_user_registration
# from DRF.company_admin.api_views.marketer_views import marketer_list, marketer_detail
from DRF.company_admin.api_views.client_views import client_list, client_detail
from DRF.company_admin.api_views.add_estate_plot_views import AddEstatePlotView, get_add_estate_plot_details
from DRF.company_admin.api_views.estate_list_views import get_estate_list, update_estate

from DRF.company_admin.api_views.plot_allocation_views  import (
    check_availability, available_plot_numbers, load_plots_for_plot_allocation, update_allocation
)

# SaaS ViewSets for multi-tenant features
from DRF.company_admin.api_views.client_dashboard_views import ClientDashboardViewSet, ClientPropertyViewViewSet
from DRF.company_admin.api_views.marketer_affiliation_views import MarketerAffiliationViewSet, MarketerCommissionViewSet
from DRF.company_admin.api_views.billing_views import InvoiceViewSet, PaymentViewSet
...
urlpatterns = [
    ...
    # NOTE: api-token-auth moved to DRF.shared_drf (DRF/shared_drf/auth_urls.py)
