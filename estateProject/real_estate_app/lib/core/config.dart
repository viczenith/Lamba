class Config {
  // Machine IPv4 – reachable by phone on the same Wi-Fi network.
  // Trailing '/api' included because DRF is mounted at /api/ in Django.
  static const String devBaseUrl = 'http://10.63.53.72:8000/api';
